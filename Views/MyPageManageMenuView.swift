...
struct MyPageManageMenuView: View {
    ...
    private var privacySection: some View {
        Section {
            ...
            Text("非公開アカウントをオンにすると、あなたをフォローしていない方には投稿が表示されなくなります。あらかじめご了承ください。")
        }
    }
    ...
    private var notificationSection: some View {
        Section {
            ...
            Text("こちらでは通知のON/OFFのみを管理いたします。端末本体の通知許可がオフになっている場合は、そちらの設定が優先されますので、あわせてご確認ください。")
        }
    }
    ...
    private var appSection: some View {
        Section {
            ...
            Text("データ通信節約モードをオンにすると、タイムラインの画像の先読みを控えめにいたします。コミュニティカレンダー保存時の確認は、予定の保存先を確認するダイアログをもう一度表示したい場合にオンにしてください。")
        }
    }
